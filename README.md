...
@import - used to link all css sytles to the page. e.g. (index.css)
@media - used to set viewport size style requirements for smaller screens. e.g. (profile.css line 78-112)
fonts - used poppins from google across the entire website with size restrictions based on figma outline. e.g. (./vendor/fonts)
...
Project Demo: https://www.loom.com/share/dc8cc5b85fe04a998641c9b50068ceec
